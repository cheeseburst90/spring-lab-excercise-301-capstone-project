...
public class RestaurantControllerTest {
	...
	public void getAllRestaurants_basic() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.get(
				"/rest/restaurants?pagenumber=1&pagesize=10").accept(
						MediaType.ALL)
	...
	public void getAllRestaurants_zeroPage() throws Exception {
		...
		Mockito.when(restaurantService.findAllRestaurants(any(Integer.class), 
				any(Integer.class))).thenReturn(responseDto);
		RequestBuilder request = MockMvcRequestBuilders.get(
				"/rest/restaurants?pagenumber=0&pagesize=0").accept(
						MediaType.ALL)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getRestaurantsByRating() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/rating/4.3?pagenumber=1&pagesize=10")
	...
	public void getRestaurantsByRating_zeropgaenumber() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/rating/4.3?pagenumber=0&pagesize=10")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getRestaurantsByRating_zero_pagesize() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/rating/4.3?pagenumber=1&pagesize=0")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getRestaurantsByName() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/name/dominos?pagenumber=1&pagesize=10")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getRestaurantsByName_zero() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/name/dominos?pagenumber=0&pagesize=10")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getRestaurantsByName_zeropagesize() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/name/dominos?pagenumber=1&pagesize=0")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getRestaurantsByLocationAndCuisine() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/location/rr/cuisine/italian?pagenumber=1&pagesize=10")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getRestaurantsByLocationAndCuisine_zero_pagenumber() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/location/rr/cuisine/italian?pagenumber=0&pagesize=10")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getRestaurantsByLocationAndCuisine_zero_pagesize() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/location/rr/cuisine/italian?pagenumber=1&pagesize=0")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getRestaurantsByLocationAndName() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/name/dominos/location/rr?pagenumber=1&pagesize=10")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getRestaurantsByLocationAndName_bad() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/name/dominos/location/rr?pagenumber=0&pagesize=10")
	...
	public void getRestaurantsByBudget() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/budget/400?pagenumber=1&pagesize=10")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getRestaurantsByBudget_zero() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurants/budget/400?pagenumber=0&pagesize=10")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
	...
	public void getItemsByRestaurantId_basic() throws Exception {
		...
		// request
		RequestBuilder request = MockMvcRequestBuilders
				.get("/rest/restaurant/items/1?pagenumber=1&pagesize=10")
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION,
						jwt);
